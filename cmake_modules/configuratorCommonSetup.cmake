...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  set(majorver ${HPCC_CONFIGURATOR_MAJOR})
  set(minorver ${HPCC_CONFIGURATOR_MINOR})
  set(point ${HPCC_CONFIGURATOR_POINT})
  if ( "${HPCC_CONFIGURATOR_MATURITY}" STREQUAL "release" )
    set(stagever "${HPCC_CONFIGURATOR_SEQUENCE}")
  else()
    set(stagever "${HPCC_CONFIGURATOR_MATURITY}${HPCC_CONFIGURATOR_SEQUENCE}")
  endif()
